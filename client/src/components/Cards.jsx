...
const Cards = ({item}) => {
  ...
  <div className={`rating gap-1 absolute right-2 top-2 p-4 heartStart bg-green ${isHeartFilled? "text-rose-500": "text-white"}`} onClick={handleHEartClick}>
  ...
  <div className="card-body">
    <Link to={`/menu/${item._id}`}><h2 className="card-title text-black">{item.name}</h2></Link>
