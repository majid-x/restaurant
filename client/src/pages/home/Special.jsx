  ...
  return (
    <div className='section-container my-20 bg-white relative'>
        ...
        <div className='md:absolut right-3 top-8 mb-10 md:mr-2'>
            <button onClick={()=>slider?.current?.slickPrev()} className='btn p-2 rounded-full bg-white hover:bg-white ml-5'>
                <FaAngleLeft className='w-8 h-8 p-1'></FaAngleLeft>
            </button>
            <button onClick={()=> slider?.current?.slickNext()} className='btn p-2 rounded-full bg-green hover:bg-green ml-5'>
